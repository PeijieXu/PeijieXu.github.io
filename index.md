...
* Decreased AVD to 5.4×10^-4 p.u. and 3.6×10<sup>-4</sup> p.u. using policy trained by DDPG-based and Multi-Agent DDPG-based method respectively, which means the proposed multi-agent-based method improves the control performance by 33.33%
* <u>**[Click for detail ...](Projects_Details/1_underguaduate_thesis.md)**</u>
